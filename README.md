...
![App Screenshot](assets/screenshot_placeholder.png) <!-- Use your generate_image tool or capture a real one if needed, but for now placeholder is fine if I don't have a final capture -->
